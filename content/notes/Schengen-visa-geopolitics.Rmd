...
Such patterns could indicate that the share of MEVs is something that is decided at the level of the state through general policies (or quotas) applied in its consulates.
